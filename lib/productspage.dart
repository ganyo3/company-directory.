...
Future<List<dynamic>> fetchAlbum() async {
  var result = await http
      .get(Uri.parse('https://fakerapi.it/api/v1/products?_quantity=1&_taxes=12&_categories_type=uuid'));
                           ...
                           children: [
                             ...
                             Padding(
                               ...
                               child: FutureBuilder<dynamic>(
                                 ...
                                 builder: (context, snapshot) {
                                   if (snapshot.hasData) {
                                     return Text(snapshot.data[index]['price']);
                                   } else {
                                     return Text('${snapshot.error}');
                                   }
                                   // By default, show a loading spinner.
                             ...
                             Padding(
                               ...
                               child: FutureBuilder<dynamic>(
                                 ...
                                 builder: (context, snapshot) {
                                   if (snapshot.hasData) {
                                     return Text(snapshot.data[index]['taxes']);
                                   } else {
                                     return Text('${snapshot.error}');
                                   }
                                   // By default, show a loading spinner.
